...
* Copyright:   Pico Technology Limited 2002 - 2021
* Description:
*
...
#define PICO_RATIO_MODE_REQUIRES_NUMBER_OF_SAMPLES_TO_BE_SET 0x02200002UL
...
#define PICO_FRONTPANEL_FIRMWARE_UPDATE_REQUIRED_TO_USE_DEVICE_WITH_THIS_DRIVER   0x0300400AUL
