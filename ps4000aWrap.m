function [methodinfo,structs,enuminfo,ThunkLibName]=ps4000aWrap
%PS4000AWRAP Create structures to define interfaces found in 'ps4000aWrap'.

%This function was generated by loadlibrary.m parser version  on Fri Apr  2 13:46:55 2021
%perl options:'ps4000aWrap.i -outfile=ps4000aWrap.m -thunkfile=ps4000aWrap_thunk_pcwin64.c -header=ps4000aWrap.h'
...
% extern PICO_STATUS setTriggerConditions ( int16_t handle , int32_t * conditionsArray , int16_t nConditions , int32_t info ); 
...
% extern PICO_STATUS setTriggerDirections ( int16_t handle , int32_t * directionsArray , int16_t nDirections ); 
...
% extern PICO_STATUS setPulseWidthQualifierConditions ( int16_t handle , int32_t * conditionsArray , int16_t nConditions , int32_t info ); 
...
% extern PICO_STATUS  setProbeInteractionCallback ( int16_t handle ); 
...
% extern PICO_STATUS  hasProbeStateChanged ( int16_t handle , int16_t * probeStateChanged ); 
...
% extern PICO_STATUS  clearProbeStateChanged ( int16_t handle ); 
...
% extern PICO_STATUS getUserProbeInteractionsInfo ( int16_t handle , PS4000A_USER_PROBE_INTERACTIONS * probes , uint32_t * nProbes ); 
...
% extern PICO_STATUS getNumberOfProbes ( int16_t handle , int32_t * numberOfProbes ); 
...
% extern PICO_STATUS getUserProbeTypeInfo ( int16_t handle , int32_t probeNumber , int16_t * connected , int32_t * channel , int16_t * enabled , int32_t * probeName , int8_t * requiresPower , int8_t * isPowered ); 
...
% extern PICO_STATUS getUserProbeRangeInfo ( int16_t handle , int32_t probeNumber , int32_t * probeOff , int32_t * rangeFirst , int32_t * rangeLast , int32_t * rangeCurrent ); 
...
% extern PICO_STATUS getUserProbeCouplingInfo ( int16_t handle , int32_t probeNumber , int32_t * couplingFirst , int32_t * couplingLast , int32_t * couplingCurrent ); 
...
% extern PICO_STATUS getUserProbeBandwidthInfo ( int16_t handle , int32_t probeNumber , int32_t * filterFlags , int32_t * filterCurrent , int32_t * defaultFilter ); 
